export interface PersonalityTheme {
  glow: string;      // CSS rgba for background glow
  accent: string;    // hex color for accent elements
  gradientFrom: string;  // hex for gradient start
  gradientTo: string;    // hex for gradient end
}

export const DEFAULT_THEME: PersonalityTheme = {
...
export const TYPE_LIBRARY: Record<string, PersonalityType> = {
  CTRL: {
    ...
    theme: { glow: 'rgba(59,130,246,0.12)', accent: '#3B82F6', gradientFrom: '#3B82F6', gradientTo: '#06B6D4' },
  },
  'ATM-er': {
    code: 'ATM-er',
    cn: '送钱者',
    ...
    theme: { glow: 'rgba(245,158,11,0.12)', accent: '#F59E0B', gradientFrom: '#F59E0B', gradientTo: '#F97316' },
  },
  'Dior-s': {
    code: 'Dior-s',
    cn: '屌丝',
    ...
    theme: { glow: 'rgba(148,163,184,0.12)', accent: '#94A3B8', gradientFrom: '#94A3B8', gradientTo: '#64748B' },
  },
  BOSS: {
    code: 'BOSS',
    cn: '领导者',
    ...
    theme: { glow: 'rgba(234,179,8,0.12)', accent: '#EAB308', gradientFrom: '#EAB308', gradientTo: '#F59E0B' },
  },
  'THAN-K': {
    code: 'THAN-K',
    cn: '感恩者',
    ...
    theme: { glow: 'rgba(251,146,60,0.12)', accent: '#FB923C', gradientFrom: '#FB923C', gradientTo: '#FBBF24' },
  },
  'OH-NO': {
    code: 'OH-NO',
    cn: '哦不人',
    ...
    theme: { glow: 'rgba(239,68,68,0.12)', accent: '#EF4444', gradientFrom: '#EF4444', gradientTo: '#F97316' },
  },
  GOGO: {
    code: 'GOGO',
    cn: '行者',
    ...
    theme: { glow: 'rgba(34,197,94,0.12)', accent: '#22C55E', gradientFrom: '#22C55E', gradientTo: '#10B981' },
  },
  SEXY: {
    code: 'SEXY',
    cn: '尤物',
    ...
    theme: { glow: 'rgba(236,72,153,0.12)', accent: '#EC4899', gradientFrom: '#EC4899', gradientTo: '#F43F5E' },
  },
  'LOVE-R': {
    code: 'LOVE-R',
    cn: '多情者',
    ...
    theme: { glow: 'rgba(244,63,94,0.12)', accent: '#F43F5E', gradientFrom: '#F43F5E', gradientTo: '#EC4899' },
  },
  MUM: {
    code: 'MUM',
    cn: '妈妈',
    ...
    theme: { glow: 'rgba(251,113,133,0.12)', accent: '#FB7185', gradientFrom: '#FB7185', gradientTo: '#F59E0B' },
  },
  FAKE: {
    code: 'FAKE',
    cn: '伪人',
    ...
    theme: { glow: 'rgba(139,92,246,0.12)', accent: '#8B5CF6', gradientFrom: '#8B5CF6', gradientTo: '#6366F1' },
  },
  OJBK: {
    code: 'OJBK',
    cn: '无所谓人',
    ...
    theme: { glow: 'rgba(107,114,128,0.12)', accent: '#6B7280', gradientFrom: '#6B7280', gradientTo: '#475569' },
  },
  MALO: {
    code: 'MALO',
    cn: '吗喽',
    ...
    theme: { glow: 'rgba(132,204,22,0.12)', accent: '#84CC16', gradientFrom: '#84CC16', gradientTo: '#22C55E' },
  },
  'JOKE-R': {
    code: 'JOKE-R',
    cn: '小丑',
    ...
    theme: { glow: 'rgba(217,70,239,0.12)', accent: '#D946EF', gradientFrom: '#D946EF', gradientTo: '#EC4899' },
  },
  'WOC!': {
    code: 'WOC!',
    cn: '握草人',
    ...
    theme: { glow: 'rgba(14,165,233,0.12)', accent: '#0EA5E9', gradientFrom: '#0EA5E9', gradientTo: '#3B82F6' },
  },
  'THIN-K': {
    code: 'THIN-K',
    cn: '思考者',
    ...
    theme: { glow: 'rgba(99,102,241,0.12)', accent: '#6366F1', gradientFrom: '#6366F1', gradientTo: '#3B82F6' },
  },
  SHIT: {
    code: 'SHIT',
    cn: '愤世者',
    ...
    theme: { glow: 'rgba(220,38,38,0.12)', accent: '#DC2626', gradientFrom: '#DC2626', gradientTo: '#F43F5E' },
  },
  ZZZZ: {
    code: 'ZZZZ',
    cn: '装死者',
    ...
    theme: { glow: 'rgba(29,78,216,0.12)', accent: '#1D4ED8', gradientFrom: '#1D4ED8', gradientTo: '#6366F1' },
  },
  POOR: {
    code: 'POOR',
    cn: '贫困者',
    ...
    theme: { glow: 'rgba(113,113,122,0.12)', accent: '#71717A', gradientFrom: '#71717A', gradientTo: '#475569' },
  },
  MONK: {
    code: 'MONK',
    cn: '僧人',
    ...
    theme: { glow: 'rgba(20,184,166,0.12)', accent: '#14B8A6', gradientFrom: '#14B8A6', gradientTo: '#06B6D4' },
  },
  IMSB: {
    code: 'IMSB',
    cn: '傻者',
    ...
    theme: { glow: 'rgba(249,115,22,0.12)', accent: '#F97316', gradientFrom: '#F97316', gradientTo: '#F59E0B' },
  },
  SOLO: {
    code: 'SOLO',
    cn: '孤儿',
    ...
    theme: { glow: 'rgba(71,85,105,0.12)', accent: '#475569', gradientFrom: '#475569', gradientTo: '#6B7280' },
  },
  FUCK: {
    code: 'FUCK',
    cn: '草者',
    ...
    theme: { glow: 'rgba(239,68,68,0.12)', accent: '#EF4444', gradientFrom: '#EF4444', gradientTo: '#F59E0B' },
  },
  DEAD: {
    code: 'DEAD',
    cn: '死者',
    ...
    theme: { glow: 'rgba(75,85,99,0.12)', accent: '#4B5563', gradientFrom: '#4B5563', gradientTo: '#71717A' },
  },
  IMFW: {
    code: 'IMFW',
    cn: '废物',
    ...
    theme: { glow: 'rgba(253,164,175,0.12)', accent: '#FDA4AF', gradientFrom: '#FDA4AF', gradientTo: '#F43F5E' },
  },
  HHHH: {
    code: 'HHHH',
    cn: '傻乐者',
    ...
    theme: { glow: 'rgba(168,85,247,0.12)', accent: '#A855F7', gradientFrom: '#A855F7', gradientTo: '#EC4899' },
  },
  DRUNK: {
    code: 'DRUNK',
    cn: '酒鬼',
    ...
    theme: { glow: 'rgba(217,119,6,0.12)', accent: '#D97706', gradientFrom: '#D97706', gradientTo: '#DC2626' },
  },
};
...
// Group types by personality tendency for the types overview page
export const TYPE_GROUPS = [
  {
    name: '掌控型',
    description: '强执行力、目标驱动、自信果断',
    color: '#ef4444',
    codes: ['CTRL', 'BOSS', 'GOGO', 'ATM-er', 'POOR'],
  },
  {
    name: '情感型',
    description: '感性丰富、重视关系、共情力强',
    color: '#f59e0b',
    codes: ['LOVE-R', 'MUM', 'SEXY', 'THAN-K', 'MALO'],
  },
  {
    name: '独行型',
    description: '重视边界、独立思考、内心世界丰富',
    color: '#8b5cf6',
    codes: ['THIN-K', 'MONK', 'SOLO', 'OJBK', 'DEAD'],
  },
  {
    name: '反叛型',
    description: '打破规则、情绪直接、不拘一格',
    color: '#10b981',
    codes: ['FUCK', 'SHIT', 'WOC!', 'OH-NO', 'FAKE'],
  },
  {
    name: '迷茫型',
    description: '自我探索中、内心矛盾、潜力待释放',
    color: '#3b82f6',
    codes: ['IMSB', 'IMFW', 'JOKE-R', 'Dior-s', 'ZZZZ', 'HHHH', 'DRUNK'],
  },
];

// Helper to get URL-safe code
...
// Get all type codes for SSG
export function getAllTypeCodes(): string[] {
  return Object.keys(TYPE_LIBRARY);
}
